...
public class Project {
	...
	public List<Item> getAllCompletedItems(){
		final String apimethod = "getAllCompletedItems";
		Type collectionType = new TypeToken<CompletedItems>(){}.getType();
		Map<String, String> params = new HashMap<String, String>();
		params.put("project_id", this.getId());
		CompletedItems completedItems =(CompletedItems)Json.getObject(apimethod, params, collectionType);; 
		return  completedItems.getItems();

//		return getItemsAnyway(apimethod);
	}
	...
	private List<Item> getItemsAnyway(final String apimethod) {
		Map<String, String> params = new HashMap<String, String>();
		params.put("project_id", this.getId());
		try {
