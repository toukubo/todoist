...
public class Json {
	...
	public static void postItem(String apimethod,Map<String, String> params) throws Exception {
...
//		final Gson gson = new Gson();
	...
	private static void post(String apimethod, String paramString)
			throws Exception {
...
//		Utils.printLabels(labels);
	...
	private static List getObjects(String apimethod, Map<String, String> params,Type collectionType) {
		try {
			Gson gson = new Gson();
			String paramString = Json.toParamString(params);
